		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
                        <p class="fs-4 text-center" style="font-size: 2.5rem;">Add Doctor</p>
                        ...
                        <!-- Registration Form -->
                        <form action="${pageContext.request.contextPath}/adminAddDoctor" method="post">
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn bg-success text-white col-md-12">Add Doctor</button>
                        </form>
                    </div>
                </div>
            </div>
